...
<html>
    <head>        
     <script type="text/javascript" src='<c:url value="/javascript/app/requisitos/common/actividad/popupBusqActividad.js" />' charset="utf-8"></script>
    </head>
    <body>
<!--    <form id="frmBusqActividad">-->
        <input type="hidden" id="idProcedimientoAct" value="${idProcedimientoAct}">
        <input type="hidden" id="idTramiteAct" value="${idTramiteAct}">
     
			     <div class="pui-panel-content" >
                        <div class="filaFormMarg">
                            <input type="hidden" id="idActividadesSelecEspe"/>
                            <div id="arbolActividadesEspe" style="height:300px;width:700px;" seleccion="${seleccion}">

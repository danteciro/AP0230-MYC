...
<t:template pageTitle="Registro de Concursos" scrollPanelTitle="">
    <jsp:attribute name="headArea">
        <script type="text/javascript" src='<c:url value="/javascript/app/general/mantenimiento/concurso.js" />' charset="utf-8"></script>
    </jsp:attribute>
    <jsp:attribute name="bodyArea">
        ...
        <div id="dialogMantConcurso" class="dialog"  title="Mantenimiento Concurso" style="display:none;">
            <form id="frmMantConcurso" class="tac">
                ...
                <div id="botones">
                    <input id="btnAgregarConcurso" class="btn_a btn_small" type="button" value="Guardar" title="Guardar Zonificación">
                    <!--seg:botonTag code="IN" value="Guardar" styleClass="btn_a btn_small" id="btnAgregarConcurso" title="Agregar Detalle Zonificación" onclick=""/-->
                </div>
                <div class="gridMargin">
            ...
            <div id="botones">
                ...
                <!--seg:botonTag code="IN" value="Guardar" styleClass="btn_a btn_small" id="btnGuardarConcurso" title="Guardar Zonificación" onclick=""/-->
                <button id="btnEditarConcurso" title="Editar Etapa" style="display:none;">Editar</button> 
                <!--seg:botonTag code="MO" value="Editar " styleClass="btn_a btn_small" id="btnEditarConcurso" title="Editar Zonificación" onclick=""/-->

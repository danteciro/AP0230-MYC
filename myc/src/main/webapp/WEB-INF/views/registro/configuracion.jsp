...
<t:template pageTitle="CONFIGURACIONES REGISTRO" scrollPanelTitle="">
    ...
    <jsp:attribute name="bodyArea">
        <div class="tac titua">CONFIGURACIONES DE REGISTRO</div>
        <ul id="menubar" style="display:none;">  
            <li> <a data-icon="ui-icon-document"></a>  
                <ul>   
             
                    <li><a class="menuItem" image="/myc/images/proceso.png" href="/myc/pages/actividadesController"><p>ACTIVIDADES</p></a></li>
                    <li><a class="menuItem" image="/myc/images/procedimiento.png" href="/myc/pages/oficinasRegionales"><p>MACROREGIONES</p></a></li>
                </ul>  
            </li>  
        </ul>

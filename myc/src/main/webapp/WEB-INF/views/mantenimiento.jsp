...
<t:template pageTitle="Mantenimientos" scrollPanelTitle="">
    ...
    <jsp:attribute name="bodyArea">
        <div class="tac titua">MANTENIMIENTO</div>
        <ul id="menubar" style="display:none;">  
            <li> <a data-icon="ui-icon-document"></a>  
                <ul>   
                    <li><a class="menuItem" image="/myc/images/requirement.png" href="/myc/pages/principal/mantenimientoRequisitos"><p>REQUISITOS</p></a></li>
                    <li><a class="menuItem" image="/myc/images/obligation.png" href="/myc/pages/principal/mantenimientoObligaciones"><p>OBLIGACIONES</p></a></li>
                    <li><a class="menuItem" image="/myc/images/configure.png" href="/myc/pages/principal/mantenimientoGeneral"><p>GENERAL</p></a></li>
                </ul>  
            </li>  
        </ul>

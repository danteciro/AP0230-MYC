...
public class BeanTest implements Serializable{
	...
	//Cristhian: Estoy creando el campo: campoCodTipopersona, utilizado para el beanExpediente(el bean traido de SIGED)
	private String campoCodTipopersona;
	//agregando campos para la direccion legal utlizado para el paso 3
	...
	public String getCampoCodTipopersona() {
		return campoCodTipopersona;
	}
	public void setCampoCodTipopersona(String campoCodTipopersona) {
		this.campoCodTipopersona = campoCodTipopersona;
	}

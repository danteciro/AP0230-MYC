...
public class CrudException extends BaseException{
     ...
     * @param exception
     */
    public CrudException(String message, Exception exception) {
     ...
     * @param exception
     */
    public CrudException(String codigo, Exception exception, boolean buscarCodigo) {		
     ...
     * @param exception
     */
    public CrudException(String codigo, String message, Exception exception) {		

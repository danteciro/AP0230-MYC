...
CREATE UNIQUE INDEX XPKPGH_ESTRATO ON PGH_ESTRATO (ID_ESTRATO   ASC);
...
CREATE UNIQUE INDEX XPKPGH_ESTRATO_UBIGEO ON PGH_ESTRATO_UBIGEO (ID_ESTRATO_UBIGEO   ASC);
ALTER TABLE PGH_ESTRATO ADD CONSTRAINT  XPKPGH_ESTRATO PRIMARY KEY (ID_ESTRATO);
ALTER TABLE PGH_ESTRATO_UBIGEO ADD CONSTRAINT  XPKPGH_ESTRATO_UBIGEO PRIMARY KEY (ID_ESTRATO_UBIGEO);
...
CREATE UNIQUE INDEX XPKPGH_UBIGEO_REGION ON PGH_UBIGEO_REGION (ID_UBIGEO_REGION   ASC);
ALTER TABLE PGH_UBIGEO_REGION ADD CONSTRAINT  XPKPGH_UBIGEO_REGION PRIMARY KEY (ID_UBIGEO_REGION);
...
CREATE UNIQUE INDEX XPKPGH_OBLIGACION_SUB ON PGH_OBLIGACION_SUB_TIPO (ID_OBLIGACION_SUB_TIPO   ASC);
ALTER TABLE PGH_OBLIGACION_SUB_TIPO ADD CONSTRAINT  XPKPGH_OBLIGACION_SUB PRIMARY KEY (ID_OBLIGACION_SUB_TIPO);
...
CREATE UNIQUE INDEX XPKPGH_CONF ON PGH_CONF_FILTRO_EMP_SUP (ID_FILTRO_EMP_SUP   ASC);
ALTER TABLE PGH_CONF_FILTRO_EMP_SUP ADD CONSTRAINT  XPKPGH_CONF PRIMARY KEY (ID_FILTRO_EMP_SUP);
...
CREATE UNIQUE INDEX XPKPGH_UNID ON PGH_UNID_OBLI_SUB_TIPO
(ID_UNID_OBLI_SUB_TIPO   ASC);
ALTER TABLE PGH_UNID_OBLI_SUB_TIPO
ADD CONSTRAINT  XPKPGH_UNID PRIMARY KEY (ID_UNID_OBLI_SUB_TIPO);
ALTER TABLE PGH_UNID_OBLI_SUB_TIPO

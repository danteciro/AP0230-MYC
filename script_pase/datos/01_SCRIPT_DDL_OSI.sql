...
-- ALINEA SEQUENCES
DROP SEQUENCE "MDI_ACTIVIDAD_SEQ";
DECLARE
  V_VALOR    NUMBER;
  V_COMANDO VARCHAR2(4000);
BEGIN
    SELECT nvl(MAX(ID_ACTIVIDAD)+1,1) INTO V_VALOR  FROM MDI_ACTIVIDAD;
    V_COMANDO:='CREATE SEQUENCE "MDI_ACTIVIDAD_SEQ"  START WITH '||V_VALOR||' INCREMENT BY 1  NOMAXVALUE  NOCACHE';
